# Twilio Serverless Frontline Integration Service V2
...
- Support for WhatsApp Template ("whatsAppApproved")
- Integration into Segment for Tracking Customer Consent
- Integration into SendGrid for Sending Non-complaint Email to Supervisor
- Use Case: Customer's Consent (Auto Replacing of Message if Consent Is Not Given)
- Use Case: Worker's Non-compliant Message - Auto Reject & Send Email
