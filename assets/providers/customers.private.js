      ...
      .eachPage(
        function page(records, fetchNextPage) {
          ...
          records.forEach(function (record) {
            const formattedConsent = record.get("consent") || false;
            ...
            let formattedRecord = {
              ...
              links: [
                {
                  type: "LinkedIn",
                  value: record.get("linkedin"),
                  display_name: "Social Media Profile",
                },
                {
                  type: "Email",
                  value: `mailto:${record.get("email")}`,
...
const updateConsentByCustomerId = async (context, id, fields) => {
  console.log("updating airtable contact");
